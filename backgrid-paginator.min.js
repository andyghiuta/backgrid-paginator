...
intervalSize:10,/**
    ...
    */
controls:{first:{label:"&#xf100;",title:"First Page"},rewind:{label:"&#xf100;",title:"Previous Interval"},back:{label:"&#xf104;",title:"Previous Page"},forward:{label:"&#xf105;",title:"Next Page"},fastForward:{label:"&#xf101;",title:"Next Interval"},last:{label:"&#xf101;",title:"Last Page"}},/** @property */
...
goBackFirstOnSort:!0,/**
    ...
    */
initialize:function(b){var c=this;c.controls=a.defaults(b.controls||{},c.controls,e.prototype.controls),a.extend(c,a.pick(b||{},"intervalSize","pageHandle","goBackFirstOnSort","renderIndexedPageHandles","renderMultiplePagesOnly"));var d=c.collection;c.listenTo(d,"add",c.render),c.listenTo(d,"remove",c.render),c.listenTo(d,"reset",c.render),c.listenTo(d,"backgrid:sorted",function(){c.goBackFirstOnSort&&d.state.currentPage!==d.state.firstPage&&d.getFirstPage({reset:!0})})},getPagesBefore:function(a,b){return Math.floor(b/2)},getPagesAfter:function(a,b){return Math.ceil(b/2)},_calculateInterval:function(){var a=this.collection,b=a.state,c=b.firstPage,d=+b.lastPage;d=Math.max(0,c?d-1:d);var e=Math.max(b.currentPage,b.firstPage);e=c?e-1:e;var f=e-this.getPagesBefore(e,this.intervalSize),g=e+this.getPagesAfter(e,this.intervalSize);return f<0&&(g-=f,f=0),g>d+1&&(g=d+1,g>this.intervalSize&&(f=g-this.intervalSize)),[f,g]},/**
